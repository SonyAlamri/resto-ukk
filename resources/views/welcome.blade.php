<x-guest-layout>
    ...
    <div class="container max-w-lg px-4 py-32 mx-auto text-left bg-center bg-no-repeat bg-cover md:max-w-none md:text-center"
        ...
        <h1
            ...
            <span class="inline md:block">Welcome To My Resto</span>
        </h1>
        ...
        <div class="grid gap-2 lg:grid-cols-3">
            <div class="max-w-md p-4 bg-white rounded-lg shadow-lg">
                ...
                <div class="flex justify-end mt-4">
                    <a href="#" class="text-xl font-medium text-green-500">Kuro</a>
                </div>
            </div>
            <div class="max-w-md p-4 bg-white rounded-lg shadow-lg">
                <div class="flex justify-center -mt-16 md:justify-end">
                ...
                <div class="flex justify-end mt-4">
                    <a href="#" class="text-xl font-medium text-green-500">Christine</a>
                </div>
            </div>
            <div class="max-w-md p-4 bg-white rounded-lg shadow-lg">
                <div class="flex justify-center -mt-16 md:justify-end">
                ...
                <div class="flex justify-end mt-4">
                    <a href="#" class="text-xl font-medium text-green-500">Benjamin</a>
                </div>
            </div>
        </div>
    </section>
